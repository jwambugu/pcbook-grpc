...
openssl req -newkey rsa:4096 -nodes -keyout client-key.pem -out client-req.pem -subj "/C=KE/ST=Nairobi/L=Nairobi/O=PC Book/OU=Software Development/CN=*.pcbook.dev/emailAddress=hi@pcbook.dev"
